 ...
 * context
 */
fun Context.toast(text: CharSequence) = com.niuub.kotlinx.toast(context = this, text = text, duration = Toast.LENGTH_SHORT)

fun Context.longToast(text: CharSequence) = com.niuub.kotlinx.toast(context = this, text = text, duration = Toast.LENGTH_LONG)
