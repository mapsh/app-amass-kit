...
/**
 * @author  mapsh on 2018/1/25 15:37.
 *
 *
 * 加密/解密相关的扩展函数
 ...
 * @param salt 盐值
 */
fun String.md5(salt: String = ""): String = com.niuub.kotlinx.hashFunc("MD5", this + salt)

/**
 * 文件MD5加密
 *
 */
fun File.md5(): String = com.niuub.kotlinx.hashFuncForFile("MD5", inputStream())
 ...
 * SHA1加密
 */
fun String.sha1(): String = com.niuub.kotlinx.hashFunc("SHA1", this)

/**
 * SHA224加密
 */
fun String.sha224(): String = com.niuub.kotlinx.hashFunc("SHA224", this)

/**
 * SHA256加密
 */
fun String.sha256(): String = com.niuub.kotlinx.hashFunc("SHA256", this)

/**
 * SHA384加密
 */
fun String.sha384(): String = com.niuub.kotlinx.hashFunc("SHA384", this)

/**
 * SHA512加密
 */
fun String.sha512(): String = com.niuub.kotlinx.hashFunc("SHA512", this)
 ...
 * @param key
 */
fun String.hmacMD5(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacMD5", key)
 ...
 * @param key
 */
fun String.hmacSHA1(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacSHA1", key)
 ...
 * @param key
 */
fun String.hmacSHA224(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacSHA224", key)
 ...
 * @param key
 */
fun String.hmacSHA256(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacSHA256", key)
 ...
 * @param key
 */
fun String.hmacSHA384(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacSHA384", key)
 ...
 * @param key
 */
fun String.hmacSHA512(key: String): String = com.niuub.kotlinx.hmacFunc(this, "HmacSHA512", key)
...
private fun deriveKeyInsecurely(password: String, keySizeInBytes: Int, encryptType: String = "AES"): SecretKey =
        SecretKeySpec(com.niuub.kotlinx.InsecureSHA1PRNGKeyDerivator.deriveInsecureKey(password.toByteArray(), keySizeInBytes), encryptType)
...
private fun encryptOrDecryptAES(raw: Key, clear: ByteArray, transformation: String, isEncrypt: Boolean): ByteArray {
    return try {
        ...
        cipher.init(if (isEncrypt) Cipher.ENCRYPT_MODE else Cipher.DECRYPT_MODE, raw, IvParameterSpec(ByteArray(cipher.blockSize)))
...
fun String.encryptAES(password: String, keySizeInBytes: Int = 32, transformation: String = "AES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, keySizeInBytes)
    val result = com.niuub.kotlinx.encryptOrDecryptAES(rawKey, this.toByteArray(), transformation, true)
    return result.toHex()
}
...
fun String.decryptAES(password: String, keySizeInBytes: Int = 32, transformation: String = "AES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, keySizeInBytes)
    val result = com.niuub.kotlinx.encryptOrDecryptAES(rawKey, this.hexToByteArray(), transformation, false)
...
fun String.decryptBase64AES(password: String, keySizeInBytes: Int = 32, transformation: String = "AES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, keySizeInBytes)
    val result = com.niuub.kotlinx.encryptOrDecryptAES(rawKey, this.base64Decode(), transformation, false)
    return String(result)
}
...
private fun encryptOrDecryptDES(raw: Key, clear: ByteArray, transformation: String, isEncrypt: Boolean): ByteArray {
    return try {
        val cipher = Cipher.getInstance(transformation)
        cipher.init(if (isEncrypt) Cipher.ENCRYPT_MODE else Cipher.DECRYPT_MODE, raw, IvParameterSpec(com.niuub.kotlinx.ivBytes))
        cipher.doFinal(clear)
    } catch (e: Exception) {
        e.printStackTrace()
        emptyArray<Byte>().toByteArray()
...
fun String.encryptDES(password: String, transformation: String = "DES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, 8, "DES")
    val result = com.niuub.kotlinx.encryptOrDecryptDES(rawKey, this.toByteArray(), transformation, true)
    return result.toHex()
}
...
fun String.decryptDES(password: String, transformation: String = "DES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, 8, "DES")
    val result = com.niuub.kotlinx.encryptOrDecryptDES(rawKey, this.hexToByteArray(), transformation, false)
    return String(result)
}
...
fun String.decryptBase64DES(password: String, transformation: String = "DES/CBC/PKCS5Padding"): String {
    val rawKey = com.niuub.kotlinx.deriveKeyInsecurely(password, 8, "DES")
    val result = com.niuub.kotlinx.encryptOrDecryptDES(rawKey, this.base64Decode(), transformation, false)
    return String(result)
}
...
fun String.rsaEncryptByPublicKey(publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPublicKey(this.toByteArray(), publicKey, true, transformation)
...
fun ByteArray.rsaEncryptByPublicKey(publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPublicKey(this, publicKey, true, transformation)
...
fun String.rsaDecryptByPublicKey(publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPublicKey(this.toByteArray(), publicKey, false, transformation)
...
fun ByteArray.rsaDecryptByPublicKey(publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPublicKey(this, publicKey, false, transformation)
...
fun String.rsaEncryptByPrivateKey(privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPrivateKey(this.toByteArray(), privateKey, true, transformation)
...
fun ByteArray.rsaEncryptByPrivateKey(privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPrivateKey(this, privateKey, true, transformation)
...
fun String.rsaDecryptByPrivateKey(privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPrivateKey(this.toByteArray(), privateKey, false, transformation)
...
fun ByteArray.rsaDecryptByPrivateKey(privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaEncryptOrDecryptByPrivateKey(this, privateKey, false, transformation)
...
private fun rsaSplitEncryptOrDecryptByPub(keyLength: Int, data: ByteArray, publicKey: ByteArray, isEncrypt: Boolean, transformation: String = "RSA"): ByteArray {
    //分段明文长度
    val cleartextLen = com.niuub.kotlinx.getMaxCleartextLen(keyLength)
    //密钥长度
...
fun String.rsaEncryptByPublicKey(keyLength: Int = 2048, publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPub(keyLength, this.toByteArray(), publicKey, true, transformation)
...
fun ByteArray.rsaEncryptByPublicKey(keyLength: Int = 2048, publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPub(keyLength, this, publicKey, true, transformation)
...
fun String.rsaDecryptByPublicKey(keyLength: Int = 2048, publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPub(keyLength, this.toByteArray(), publicKey, false, transformation)
...
fun ByteArray.rsaDecryptByPublicKey(keyLength: Int = 2048, publicKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPub(keyLength, this, publicKey, false, transformation)
...
fun String.rsaEncryptByPrivateKey(keyLength: Int = 2048, privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPri(keyLength, this.toByteArray(), privateKey, true, transformation)
...
fun ByteArray.rsaEncryptByPPrivateKey(keyLength: Int = 2048, privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPri(keyLength, this, privateKey, true, transformation)
...
fun String.rsaDecryptByPrivateKey(keyLength: Int = 2048, privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPri(keyLength, this.toByteArray(), privateKey, false, transformation)
...
fun ByteArray.rsaDecryptByPrivateKey(keyLength: Int = 2048, privateKey: ByteArray, transformation: String = "RSA"): ByteArray =
        com.niuub.kotlinx.rsaSplitEncryptOrDecryptByPri(keyLength, this, privateKey, false, transformation)