package com.mapsh.android.recycleview.pinned;
...
import com.mapsh.R;
import com.mapsh.android.recycleview.pinned.callback.OnHeaderClickListener;
import com.mapsh.android.recycleview.pinned.callback.OnItemTouchListener;
import com.mapsh.android.recycleview.pinned.utils.DividerHelper;
...
public class SmallPinnedHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mDrawable == null) {
            mDrawable = ContextCompat.getDrawable(parent.getContext(), mDividerId != 0 ? mDividerId : R.drawable.amass_sticky_divider);
        }
