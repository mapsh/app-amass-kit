...
public class DateUtils {
    ...
    public static Date makeDate(
            @IntRange(from = 1970) int year,
            @IntRange(from = 1, to = 12) int month,
            @IntRange(from = 1) int dayOfMonth,
            int hourOfDay,
            int minute,
            int second
    ) {
     ...
     * @return 新日期字符串
     */
    public static String stringToString(String date, DateStyle oldDteStyle,
                                        String newPattern) {
        String dateString = null;
        if (oldDteStyle != null) {
            dateString = stringToString(date, oldDteStyle.getValue(),
                    newPattern);
        }
        return dateString;
    }
    ...
    public static String stringToString(String date, String oldPattern,
        ...
        if (newDateStyle != null) {
            dateString = stringToString(date, oldPattern,
    ...
    public static String getAge(Date date, Date otherDate) {
        ...
        sb.append(year > 0 ? year + "岁" : "")
                .append(month > 0 ? month + "个月" : "")
                .append(day).append("天");
    ...
    public static boolean isSameDay(Date day1, Date day2) {
        SimpleDateFormat sdf = getDateFormat(DateStyle.YYYY_MM_DD.getValue());
    ...
    public static void main(String[] args) throws Exception {
        Date weekStart = DateUtils.addSecond(dayStart(getFirstDayOfMonth(new Date())), -1);
        System.out.println(dateToString(DateUtils.addSecond(dayEnd(DateUtils.addDay(new Date(), 6 - 1)), 1), DateStyle.YYYY_MM_DD_HH_MM_SS));
        System.out.println(dateToString(DateUtils.addSecond(dayEnd(getLastDayOfMonth(new Date())), 1), DateStyle.YYYY_MM_DD_HH_MM_SS));
    }
}
