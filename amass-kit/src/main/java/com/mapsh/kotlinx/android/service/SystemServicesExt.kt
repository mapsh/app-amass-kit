package com.mapsh.kotlinx.android.service

/**
 * @author mapsh on 2017/11/29 09:53.
 */
...
fun Context.getWifiManager() = this.applicationContext.getSystemService(Context.WIFI_SERVICE) as WifiManager
