...
inline fun <reified T : Activity> Activity.startActivity(vararg params: Pair<String, Any>) = IntentExt.startAcivity(this, T::class.java, params)

inline fun <reified T : Activity> Activity.startActivityForResult(requestCode: Int, vararg params: Pair<String, Any>) = IntentExt.startActivityForResult(this, T::class.java, requestCode, params)

inline fun <reified T : Activity> Fragment.startActivity(vararg params: Pair<String, Any>) = IntentExt.startAcivity(activity, T::class.java, params)

inline fun <reified T : Activity> Fragment.startActivityForResult(requestCode: Int, vararg params: Pair<String, Any>) = IntentExt.startActivityForResult(this, T::class.java, requestCode, params)

inline fun <reified T : Activity> android.support.v4.app.Fragment.startActivity(vararg params: Pair<String, Any>) = IntentExt.startAcivity(activity as Activity, T::class.java, params)

inline fun <reified T : Activity> android.support.v4.app.Fragment.startActivityForResult(requestCode: Int, vararg params: Pair<String, Any>) = IntentExt.startActivityForResult(this, T::class.java, requestCode, params)

inline fun <reified T : Service> Context.startService(vararg params: Pair<String, Any>) = IntentExt.startService(this, T::class.java, params)

fun Context.browse(url: String, newTask: Boolean = false) = IntentExt.browse(this, url, newTask)

fun Context.email(email: String, subject: String = "", text: String = "") = IntentExt.email(this, email, subject, text)

@SuppressLint("MissingPermission")
fun Context.makeCall(number: String): Boolean = IntentExt.makeCall(this, number)

fun Context.sendSMS(number: String, text: String = ""): Boolean = IntentExt.sendSMS(this, number, text)

fun Any.bundleOf(vararg params: Pair<String, Any>): Bundle = IntentExt.bundleOf(params)